...
addBtn.classList="rounded-sm border-2 border-solid bg-green-500 h-10 w-20 rounded-xl";
...
showHideTasksButton.classList =
  "rounded-sm border-2 border-solid bg-green-500 h-10 w-20 rounded-xl";
...
frame1.classList = "flex-row border-2 border-solid bg-blue-100 rounded-xl h-50 w-100";
mainFrame.appendChild(addBtn);
mainFrame.appendChild(showHideTasksButton);
mainFrame.appendChild(frame1);
let input_box = document.createElement("input");
input_box.id = "input-data";
input_box.placeholder = "type task name....";
input_box.classList = "border-2 bg-red-200 rounded-xl";

let taskdescription = document.createElement("textarea");
taskdescription.placeholder = "type task description...";
taskdescription.id = "taskdescription-data";
taskdescription.classList = "border-2 bg-yellow-200 rounded-xl";
...
frame1.appendChild(taskdescription);
...
msgDiv.classList = "border-2 bg-red-300 rounded-xl m-3 h-8 w-50";
msgDiv.id = "msg-block";
...
{
  let mydescription = document.getElementById("taskdescription-data");
...
function addToFrame2(task, flag) 
{
  ...
  status.addEventListener("click", ()=>{
    ...
    saveToLocalStorage(tasks);
    mytask.classList.toggle("bg-yellow-300");
  ...
  editButton.addEventListener("click", ()=>{
    ...
    Input.classList = "bg-red-200 border-2 ";

    let Description = document.createElement("textarea");
    Description.value = task.description;
    Description.classList = "bg-yellow-200 border-2 ";
    mytask.prepend(Description);
    mytask.prepend(Input);
    saveToLocalStorage(tasks);
  });
